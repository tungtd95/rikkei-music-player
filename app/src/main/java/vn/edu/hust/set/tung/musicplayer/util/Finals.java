...
public class Finals {
    ...
    public static final String KEY_LAST_LIST_SONG = "last_list_song";
    public static final String KEY_LAST_INDEX = "last_index";
    public static final String KEY_FRAGMENT_ALBUM_STATUS = "fragment album status";
    public static final String KEY_FRAGMENT_ARTIST_STATUS = "fragment artist status";
